        ...
        switch (state) {
            case 0x02:
                ...
                if (key == 1) {
                    state = 0x03;
                    clear_screen();
                    clcd_print(" SET POWER ", ((unsigned char)(0x80 + 0)));
                    clcd_print(" power = 900W ", ((unsigned char)(0xC0 + 0)));
                    ...
                    state = 0x04;
                    clear_screen();
                    clcd_print(" GRILL MODE ", ((unsigned char)(0x80 + 0)));
                    ...
                    state = 0x0A;
                    clear_screen();
                    clcd_print(" SET TEMP (C) ", ((unsigned char)(0x80 + 0)));
                    clcd_print(" TEMP: 000C ", ((unsigned char)(0xC0 + 0)));
                } else if (key == 4) {
                    min = 0;
                    sec = 30;
                    state = 0x07;
            ...
            case 0x07:
                ...
                if (min == 0 && sec == 0) {
                    ...
                    RC1 = 1;
                    clear_screen();
                    clcd_print("  TIME UP!!  ", ((unsigned char)(0xC0 + 2)));
